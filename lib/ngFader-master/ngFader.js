(function () {
    ...
    scope.images = [
        {alt: 'Brush 1', src: './img/brushing/brush1.jpg'},
        {alt: 'Brush 2', src: './img/brushing/brush2.jpg'},
        {alt: 'Brush 3', src: './img/brushing/brush3.jpg'},
        {alt: 'Brush 4', src: './img/brushing/brush4.jpg'}];
